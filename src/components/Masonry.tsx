...
const Masonry: React.FC<MasonryProps> = ({
  ...
  }, [layout.items, imagesReady, stagger, animateFrom, blurToFocus, duration, ease]);
  ...
  return (
    <div ref={containerRef} className="list" style={{ height: `${Math.max(320, Math.ceil(layout.height))}px` }}>
      {layout.items.map(item => {
        return (
          <div
            ...
            style={{ cursor: !item.url || item.url === '#' ? 'default' : 'pointer' }}
          >
